    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (header != null && header.startsWith("Bearer ")) {
            ...
            if (validator.validateToken(token)) {
                ...
                System.out.println("UserDetails created for user: " + username + " with roles: " + roles);
                Authentication auth = new UsernamePasswordAuthenticationToken(
                        userDetails, null, authorities);
                SecurityContextHolder.getContext().setAuthentication(auth);
                System.out.println("Authentication set for user: " + username + " with roles: " + roles);
                
                SecurityContextHolder.getContext().setAuthentication(auth);
            }
        }
        System.out.println("Proceeding with filter chain for request: " + request.getRequestURI());
