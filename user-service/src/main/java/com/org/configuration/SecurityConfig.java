package com.org.userservice.configuration;
...
import com.org.userservice.service.MyUserDetailsService;
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
	    ...
	    return http
	            ...
	            .authorizeHttpRequests(authorizeHttp -> authorizeHttp
	                ...
	                .requestMatchers("/v1/user/signup").permitAll()  // Ensure this line is present
